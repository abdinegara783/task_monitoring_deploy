# Generated by Django 5.1 on 2025-10-07
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('dashboard', '0005_delete_shiftschedule'),
    ]
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'shift',
                    models.IntegerField(
                        choices=[(0, 'Stop'), (1, 'Shift 1'), (2, 'Shift 2')],
                        help_text='Shift yang ditugaskan (Stop/1/2)'
                    ),
                ),
                (
                    'department',
                    models.CharField(
                        choices=[('SUPPORT', 'Support & Fabrikasi'), ('TRACK', 'Track'), ('PLANT', 'PCH'), ('WHEEL', 'Wheel')],
                        help_text='Departemen foreman',
                        max_length=100,
                    ),
                ),
