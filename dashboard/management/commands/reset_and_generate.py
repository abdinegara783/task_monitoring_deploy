        ...
        try:
            ...
            if os.path.exists(db_path):
                try:
                    ...
                    self.stdout.write('   ⚠️  Database file is locked, trying alternative method...')
    ...
    def create_users_safe(self, count):
        ...
        try:
            ...
            last_names = [
                ...
                'Hidayat', 'Setiawan', 'Raharjo', 'Susanto', 'Wibowo', 'Kurniawan'
            ]
            ...
            for batch_start in range(0, count, batch_size):
                ...
                self.stdout.write(f'   📝 Created {users_created}/{count} users...', ending='\r')
    ...
    def create_activity_reports_safe(self, count):
        ...
        try:
            ...
            for batch_start in range(0, count, batch_size):
                ...
                self.stdout.write(f'   📋 Created {reports_created}/{count} reports...', ending='\r')
            
            self.stdout.write(f'   ✅ Successfully created {reports_created} activity reports')
