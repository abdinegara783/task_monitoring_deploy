...
from dashboard.models import User, ActivityReport, AnalysisReport, LeaderQuota
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for i, foreman_data in enumerate(foremen_data):
            ...
            if leader.leader_quota.can_add_foreman():
        ...
        for foreman in foremen:
            ...
            for i in range(random.randint(5, 10)):
                ...
                ActivityReport.objects.create(
                    ...
                    Hmkm=f"{random.randint(1000, 9999)}",
